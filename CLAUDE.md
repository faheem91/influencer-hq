...
### Frontend (Vercel)
- URL: https://panel.influencerhq.io
- Deploy: `cd client && vercel --prod`

### Backend (OVH Server)
- URL: https://agent.influencerhq.io
- Host: agent.influencerhq.io
- User: ubuntu
- SSH Key: C:/Users/faheem/.ssh/faheem_ssh

```bash
# SSH into backend server
ssh -i C:/Users/faheem/.ssh/faheem_ssh ubuntu@agent.influencerhq.io

# Deploy backend (from server)
cd /home/ubuntu/apps/influencer-hq-agent
